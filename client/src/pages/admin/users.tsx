        ...
        <div className="m-3 w-full">
          <div className="m-1 flex justify-center">
            <input
              ...
              placeholder="Search..."
              className="w-96 border-[2px] border-black p-2 outline-none"
            />
          </div>
          <table className="w-full rounded-md border-2 border-black">
            ...
            <tbody className=" bg-slate-100">
              {users
                .filter(
                  (user) =>
                    user.firstName.toLowerCase().includes(filer) ||
                    user.age.toString().includes(filer) ||
                    user.lastName.toLowerCase().includes(filer) ||
                    user.email.toLowerCase().includes(filer)
                )
                .map((user) => (
